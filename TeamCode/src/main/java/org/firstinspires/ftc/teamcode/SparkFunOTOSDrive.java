...
public class SparkFunOTOSDrive extends MecanumDrive {
    public static class Params {
        ...
        // old h: 2.7825
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(0.0781, 0.0661, -3.1421);
        ...
        public double linearScalar = 1.022236483;
        public double angularScalar = 0.993;
        // 0.8948
    ...
    public SparkFunOTOSDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        otos = hardwareMap.get(SparkFunOTOSCorrected.class,"sparkfun-otos");
        // RR localizer note:
